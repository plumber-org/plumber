...
const sourceRoot = isCompiledOutput()
    ? join(apiRoot, 'dist')
    : join(apiRoot, 'src');
...
export const ENTITY_PATTERNS = [
    ...
    join(
        sourceRoot,
        'modules/**/infrastructure/persistence/typeorm/*.orm-entity{.ts,.js}',
    ),
];
...
export const MIGRATION_PATTERNS = [
    ...
    join(
        sourceRoot,
        'modules/**/infrastructure/persistence/typeorm/migrations/*{.ts,.js}',
    ),
];
